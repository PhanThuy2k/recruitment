...
use App\Models\Benefits_enjoyed;

class BenefitsEnjoyedController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $name = $request->name;
        // dd($name);
        $career = Benefits_enjoyed::orderBy('id','DESC');
        // kt name nếu có gtri
        if ($name) {
    ...
    public function store(Request $request)
    {
        ...
        $career = Benefits_enjoyed::create($request->all());
    ...
    public function show($id)
    {
        ...
        $career = Benefits_enjoyed::find($id);
        // ktra
        if (!$career) {
            $status = 'no data';
        } else {
