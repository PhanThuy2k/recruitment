...
use  App\Models\Add_recruitment_round;
use  App\Models\Type_of_recruitment_round;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

class AddRecruitmentRoundController extends Controller
{  
    /**
    ...
    public function index(Request $request)
    {
        ...
        $name = $request->name;
        // dd($name);
        $career = Add_recruitment_round::orderBy('id','DESC');
        // kt name nếu có gtri
        if ($name) {
    ...
    public function store(Request $request)
    {
        ...
        $career = Add_recruitment_round::create($request->all());
    ...
    public function show($id)
    {
        ...
        $career = Add_recruitment_round::find($id);
        // ktra
        if (!$career) {
            $status = 'no data';
        } else {
