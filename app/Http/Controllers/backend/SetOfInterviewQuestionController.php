...
use App\Models\Set_of_interview_question;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

class SetOfInterviewQuestionController extends Controller
{ 
    /**
    ...
    public function index(Request $request)
    {
        ...
        $name = $request->name;
        // dd($name);
        $career = Set_of_interview_question::orderBy('id','DESC');
        // kt name nếu có gtri
        if ($name) {
    ...
    public function store(Request $request)
    {
        ...
        $career = Set_of_interview_question::create($request->all());
    ...
    public function show($id)
    {
        ...
        $career = Set_of_interview_question::find($id);
        // ktra
        if (!$career) {
            $status = 'no data';
        } else {
