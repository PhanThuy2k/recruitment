...
class RecruitmentRoundController extends Controller
{ 
    /**
    ...
    public function index(Request $request)
    {
        ...
        $name = $request->name;
        // dd($name);
        $career = Type_of_recruitment_round::orderBy('id','DESC');
        // kt name nếu có gtri
        if ($name) {
    ...
    public function store(Request $request)
    {
        ...
        $career = Type_of_recruitment_round::create($request->all());
    ...
    public function show($id)
    {
        ...
        $career = Type_of_recruitment_round::find($id);
        // ktra
        if (!$career) {
            $status = 'no data';
        } else {
