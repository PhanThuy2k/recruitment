...
use App\Models\Interview_question;
...
{ 
    ...
    public function index(Request $request)
    {
        ...
        $name = $request->name;
        // dd($name);
        $career = Interview_question::orderBy('id','DESC');
        // kt name nếu có gtri
        if ($name) {
    ...
    public function store(Request $request)
    {
        ...
        $career = Interview_question::create($request->all());
    ...
    public function show($id)
    {
        ...
        $career = Interview_question::find($id);
        // ktra
        if (!$career) {
            $status = 'no data';
        } else {
