...
class GroupReasonTypeController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $name = $request->name;
        // dd($name);
        $career = Group_reason_type::orderBy('id','DESC');
        // kt name nếu có gtri
        if ($name) {
    ...
    public function store(Request $request)
    {
        ...
        $career = Group_reason_type::create($request->all());
    ...
    public function show($id)
    {
        ...
        $career = Group_reason_type::find($id);
        // ktra
        if (!$career) {
            $status = 'no data';
        } else {
